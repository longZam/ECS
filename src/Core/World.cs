...
public class World
{
    ...
    public delegate void ForEachDelegate<T1>(ref T1 arg1);
    public delegate void ForEachDelegate<T1, T2>(ref T1 arg1, ref T2 arg2);
    public delegate void ForEachDelegate<T1, T2, T3>(ref T1 arg1, ref T2 arg2, ref T3 arg3);
    public delegate void ForEachDelegate<T1, T2, T3, T4>(ref T1 arg1, ref T2 arg2, ref T3 arg3, ref T4 arg4);
    public delegate void ForEachDelegate<T1, T2, T3, T4, T5>(ref T1 arg1, ref T2 arg2, ref T3 arg3, ref T4 arg4, ref T5 arg5);
    public delegate void ForEachDelegate<T1, T2, T3, T4, T5, T6>(ref T1 arg1, ref T2 arg2, ref T3 arg3, ref T4 arg4, ref T5 arg5, ref T6 arg6);
    public delegate void ForEachDelegate<T1, T2, T3, T4, T5, T6, T7>(ref T1 arg1, ref T2 arg2, ref T3 arg3, ref T4 arg4, ref T5 arg5, ref T6 arg6, ref T7 arg7);
    public delegate void ForEachDelegate<T1, T2, T3, T4, T5, T6, T7, T8>(ref T1 arg1, ref T2 arg2, ref T3 arg3, ref T4 arg4, ref T5 arg5, ref T6 arg6, ref T7 arg7, ref T8 arg8);
        ...
        where T3 : struct, IComponent
    {
        ...
        {
            if ((Entities[i] & mask) == mask)
                action(ref t1[i], ref t2[i], ref t3[i]);
        });
    }
        ...
        where T4 : struct, IComponent
    {
        ...
        {
            if ((Entities[i] & mask) == mask)
                action(ref t1[i], ref t2[i], ref t3[i], ref t4[i]);
        });
    }
        ...
        where T5 : struct, IComponent
    {
        ...
        {
            if ((Entities[i] & mask) == mask)
                action(ref t1[i], ref t2[i], ref t3[i], ref t4[i], ref t5[i]);
        });
    }
        ...
        where T6 : struct, IComponent
    {
        ...
        {
            if ((Entities[i] & mask) == mask)
                action(ref t1[i], ref t2[i], ref t3[i], ref t4[i], ref t5[i], ref t6[i]);
        });
    }
        ...
        where T7 : struct, IComponent
    {
        ...
        {
            if ((Entities[i] & mask) == mask)
                action(ref t1[i], ref t2[i], ref t3[i], ref t4[i], ref t5[i], ref t6[i], ref t7[i]);
        });
    }
        ...
        where T8 : struct, IComponent
    {
        ...
        {
            if ((Entities[i] & mask) == mask)
                action(ref t1[i], ref t2[i], ref t3[i], ref t4[i], ref t5[i], ref t6[i], ref t7[i], ref t8[i]);
        });
    }
    ...
    public void AddComponent<T>(int id) where T : struct, IComponent
    {
        Components.AddComponent<T>(id);
        Entities[id] |= Components.GetMask(typeof(T));
    }
    public void RegisterSystem<T>() where T : System, new() => Systems.RegisterSystem<T>();
}